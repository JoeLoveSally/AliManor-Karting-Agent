...
def test_v4c3_delta_runtime_family_is_supported() -> None:
    assert "state_conditioned_kart_relative_v4c3_delta" in _SUPPORTED_MODEL_FAMILIES
...
def test_v4c3_delta_runtime_strips_only_auxiliary_heads() -> None:
    state_dict = {
